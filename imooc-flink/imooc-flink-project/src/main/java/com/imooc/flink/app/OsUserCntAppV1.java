...
public class OsUserCntAppV1 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    SingleOutputStreamOperator<Tuple3<String, Integer, Integer>> stream = env.readTextFile(
            "data/access.json")
  ...
  static class RedisExampleMapper implements RedisMapper<Tuple3<String, Integer, Integer>> {
    ...
    public RedisCommandDescription getCommandDescription() {
      return new RedisCommandDescription(RedisCommand.HSET, "os_user-cnt:20301002");
    }
